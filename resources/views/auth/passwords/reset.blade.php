               ...
               <div class="card border-light bg-white mt-4">
                <div class="card-body card-body-form card-form">
                    <form action="{{ route('password.update')}}" method="POST" class="form-page" style="max-width:600px;margin:auto">
                      ...
                      <div class="input-container password-field">
                        <i class="fa fa-key icon"></i>
                        <input id="password-confirm fakePassword" class="input-field" type="password" placeholder="Password" name="password_confirmation" required autocomplete="new-password">
                        <i class="fa fa-eye icon-pswrd" id="toggler"></i>
                      </div>
