          ...
          <div class="col-lg-4">
            <div class="card card-details card-right">
              ...
              <table class="trip-informations">
                    ...
                    <p class="payment-instructions">
                      ...
                      <div class="bank">
                        <div class="bank-item pb-3">
                          <img src="{{url('/frontend/images/CardCre.png') }}" alt="" class="bank-image">
                ...
                <a href="{{ route('checkout-succes', $item->id ) }}" class="btn btn-block btn-join-now mt-3 py-2">
                  I Have Made Payment
                </a>
                </div>

                <div class="join-container">
                  <a href="{{ route('detail', $item->travel_package->slug) }}" class="btn btn-block btn-cancel-request mt-4 py-2">
                    Cancel Booking
                  </a>
                  </div>
              </div>
