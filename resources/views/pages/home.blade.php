        ...
        <div class="container">
          <section class="section-stats row justify-content-center" id="stats">
            ...
            <div class="col-3 col-md-2 stats-detail">
              <h2>12</h2>
              <P>Country</P>
            </div><div class="col-3 col-md-2 stats-detail">
              <h2>3K</h2>
              <P>Hotels</P>
            </div><div class="col-3 col-md-2 stats-detail">
              <h2>2K</h2>
              ...
              <div class="col-sm-7 col-md-6 col-lg-4">
                ...
                <div class="card card-testimonial text-center">
                  <div class="testimonial-content">
                    ...
                    <h3 class="mb-4">Jhon De</h3>
                    <p class="testimonial">"The trip was Amazing and I saw Something beatiful"</p>
                  </div>
                  <hr>
                  <p class="trip-to md-2">
